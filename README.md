...
Un proyecto en `Python`, utilizando `OpenCV`, para generar un fotomosaico, un proceso en el que una imagen grande se reconstruye a partir de múltiples imágenes pequeñas. Ofreciendo un efecto artístico único.
